...
exports.validationAndSignUp = catchAsync(async (req, res, next) => {
  ...
  const IsFatherNameNotValid = new ValidationCheck(req.body.father_Name, "Father Name").IsEmpty().print()
  if(IsFatherNameNotValid) return SendErrorResponse(IsFatherNameNotValid, 400, next)

  const IsMotherNameNotValid = new ValidationCheck(req.body.mother_Name, "Mother Name").IsEmpty().print()
